...
namespace Notes.Infra.Migrations
{
    ...
    [Migration("20220925084528_ModifyCreatedByAndModifiedByTointeger")]
    partial class ModifyCreatedByAndModifiedByTointeger
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Notes.Infra.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Notes.Infra.Models.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
